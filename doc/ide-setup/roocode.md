...
> 💡 **为什么选择 RooCode + CloudBase AI Toolkit？**
> RooCode 是一款专业的 AI 编程助手，支持 VS Code 集成。结合 CloudBase AI Toolkit，让你通过自然语言描述需求，AI 自动生成并部署全栈应用到腾讯云开发平台。特别适合追求轻量级工具和简洁开发体验的个人开发者。
...
从 [RooCode 官网](https://roocode.com/) 下载并安装 VS Code 插件。
...
如果你只想下载RooCode相关的配置文件，避免项目文件混乱，可以指定IDE类型：
```
在当前项目中下载云开发 AI 规则，只包含RooCode配置
```
...
- [❓ 常见问题](../faq) - 查看常见问题解答
- [RooCode 官网](https://roocode.com/) - RooCode 官网
...
**🚀 立即开始使用 RooCode + CloudBase AI Toolkit**
